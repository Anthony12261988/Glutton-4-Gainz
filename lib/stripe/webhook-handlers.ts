...
export async function handleInvoicePaymentFailed(
  ...
  // TODO: Create in-app notification for failed payment
  // Requires notifications table migration to be created
  // try {
  ...
  // }
  console.log(`Payment failed for user ${profile.email}. Amount: $${(invoice.amount_due / 100).toFixed(2)}`);
