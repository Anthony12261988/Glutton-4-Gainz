...
export function DailyRation({ recipe, isPremium = false }: DailyRationProps) {
  // If user is not premium, show "Meal of the Day"
  if (!isPremium) {
          ...
          <CardContent>
            <div className="flex flex-col items-center justify-center py-6 text-center">
              ...
              <p className="text-sm text-muted-text">
                No featured meal today.
              </p>
              <p className="text-xs text-steel mt-2">
                Upgrade to Soldier to plan custom meals
              </p>
              <Link href="/pricing">
        ...
        <CardContent className="space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-steel mt-1">
              Today's featured recipe - upgrade to Soldier for meal planning
            </p>
          </div>
